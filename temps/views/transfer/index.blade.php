...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{__('Transfer')}}</h5>
    </div>
@endsection
@section('breadcrumb')
    <!-- <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li> -->
    <li class="breadcrumb-item">{{ __('HRM') }}</li>
    <!-- <li class="breadcrumb-item">{{ __('HR Admin') }}</li> -->
...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    ...
    data-bs-target="#exampleModal" data-url="{{ route('transfer.create') }}"
    data-bs-whatever="{{__('Create New Transfer')}}">
                                    ...
                                    <td class="text-right">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" data-url="{{ route('transfer.edit',$transfer->id) }}"
                                                data-bs-whatever="{{__('Edit Transfer')}}" > <span class="text-white"> <i
