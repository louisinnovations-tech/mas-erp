    ...
    var kb = function (eb) {
        var e = {
            ...
            Wa = function () {
                function a(c, d) {
                    ...
                    try {
                        for (
                            var q = c.querySelectorAll(
                                    b.join(':not([tabindex="-1"]), ')
                                ),
                                h,
                                n = q.length,
                                p = 0;
            ...
            La = function (a) {
                ...
                if (c) {
                    ...
                    W.textContent =
                        g.languages[a].consent_modal.primary_btn.text;
                }
                ...
                d &&
                    ...
                    (S.textContent =
                        g.languages[a].consent_modal.secondary_btn.text));
            ...
            ab = function (a) {
                ...
                for (var n = 0; n < h; ++n) {
                    ...
                    if ((w && p) || (!w && (p || F)))
                        B.appendChild(X),
                            y ? y.appendChild(B) : la.appendChild(B);
                }
                ...
                da.textContent =
                    g.languages[a].settings_modal.save_settings_btn;
                y
            ...
            gb = function (a) {
                ...
                if (0 < b.length)
                    for (var c = 0; c < b.length; c++)
                        -1 !== H(a, I[c])
                            ? ((b[c].checked = !0),
                              R[c] || (V.push(I[c]), (R[c] = !0)))
                            : ((b[c].checked = !1),
                              R[c] && (V.push(I[c]), (R[c] = !1)));
        ...
        m.run = function (a) {
            if (
                ...
                "string" === typeof g.cookie_path &&
                    (e.cookie_path = g.cookie_path),
                "string" === typeof g.cookie_name &&
                    (e.cookie_name = g.cookie_name),
        ...
        m.accept = function (a, b) {
            ...
            var d = function () {
                for (
                    var l = document.querySelectorAll(".c-tgl") || [],
                        q = [],
                        h = 0;
                    h < l.length;
                    h++
