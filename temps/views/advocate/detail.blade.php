            ...
            <div class="">
                <dl class="row">
                    ...
                    <dd class="col-md-8"><span
                            class="text-md">{{ App\Models\Country::countryById($advocate->ofc_country) }}</span></dd>

                    <dt class="col-md-4"><span class="h6 text-md mb-0">{{ __('State:') }}</span></dt>
                    <dd class="col-md-8"><span
                            class="text-md">{{ App\Models\State::StatebyId($advocate->ofc_state) }}</span></dd>
                    ...
                    <dt class="col-md-4"><span class="h6 text-md mb-0">{{ __('Country:') }}</span></dt>
                    <dd class="col-md-8"><span
                            class="text-md">{{ App\Models\Country::countryById($advocate->home_country) }}</span></dd>

                    <dt class="col-md-4"><span class="h6 text-md mb-0">{{ __('State:') }}</span></dt>
                    <dd class="col-md-8"><span
                            class="text-md">{{ App\Models\State::StatebyId($advocate->home_state) }}</span></dd>
