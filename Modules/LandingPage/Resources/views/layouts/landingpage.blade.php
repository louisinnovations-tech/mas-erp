        ...
        <div class="container">
            <nav class="navbar navbar-expand-md default top-nav-collapse">
                ...
                <div class="ms-auto d-flex justify-content-end gap-2">
                    <div class="dropdown">
                        <a href="{{ route('login') }}" class="btn btn-outline-dark rounded dropdown-toggle" id="loginButton">
                            <span class="hide-mob me-2">
                                {{ __('Login') }}
                            </span>
                            <!-- <i data-feather="log-in"></i> -->
                        </a>
                        <div class="dropdown-menu" id="loginDropdown" style="right: 0px;">
                            <a class="dropdown-item" href="{{ url('login?loginType=Client') }}">Client</a>
                            <a class="dropdown-item" href="{{ url('login?loginType=Employee') }}">Employee</a>
                        </div>
                    </div>
...
<style>
    #loginButton:hover + #loginDropdown, #loginDropdown:hover {
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('click', function (event) {
            var isClickInside = loginButton.contains(event.target) || loginDropdown.contains(event.target);
            if (!isClickInside) {
