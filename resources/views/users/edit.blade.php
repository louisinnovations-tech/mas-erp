...
@section('page-title')
    ...
    @elseif ($user->id == Auth::user()->id && $user->type == 'employee')
                ...
                <div class="col-xl-3 border-end border-bottom">
                    <div class="card shadow-none bg-transparent sticky-top" style="top:70px">
                        <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                            ...
                            @else
                                <a href="#useradd-1" class="list-group-item list-group-item-action">{{ __('Information') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                <a href="#useradd-2" class="list-group-item list-group-item-action">{{ __('Company Info') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            @endif
                ...
                <div class="col-xl-9">
                    <div id="useradd-1" class="card  shadow-none rounded-0 border-bottom">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-8 col-sm-6 col-md-6">
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                placeholder="{{ __('Enter Your Full Name') }}" value="{{ $user->name }}"
                            ...
                            @if ($user->id == Auth::user()->id && Auth::user()->type == 'advocate')
                            ...
                            @elseif($user->id == Auth::user()->id && $user->type == 'client')
                                <div class="row card-body">
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="whats_app_number" type="number"
                                                ...
                                                value="{{ !empty($user_detail->whats_app_number) ? $user_detail->whats_app_number : '' }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="building_number" type="text"
                                                ...
                                                value="{{ !empty($user_detail->building_number) ? $user_detail->building_number : '' }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="street_number" type="text"
                                                ...
                                                value="{{ !empty($user_detail->street_number) ? $user_detail->street_number : '' }}"
                                                autocomplete="street">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="zone_number" type="text"
                                                ...
                                                value="{{ !empty($user_detail->zone_number) ? $user_detail->zone_number : '' }}"
                                                autocomplete="zone">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="qid_number" type="number"
                                                ...
                                                value="{{ !empty($user_detail->qid_number) ? $user_detail->qid_number : '' }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="passport_number" type="number"
                                                ...
                                                value="{{ !empty($user_detail->passport_number) ? $user_detail->passport_number : '' }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        {{ Form::label('language', __('Select Language'), ['class' => 'form-label']) }}
                                        {!! Form::select(
                                            'language',
                                            ['en' => 'English', 'ar' => 'Arabic'],
                                            isset($user_detail) ? $user_detail->language : null,
                                            [
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="land_phone" type="number" id="landphone"
                                                ...
                                                value="{{ !empty($user_detail->land_phone) ? $user_detail->land_phone : '' }}"
                                    ...
                                    <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="extension_number" type="number"
                                                ...
                                                value="{{ !empty($user_detail->extension_number) ? $user_detail->extension_number : '' }}"
                                     ...
                                     <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="profession" type="text"
                                                ...
                                                value="{{ !empty($user_detail->profession) ? $user_detail->profession : '' }}"
                                     ...
                                     <div class="col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " name="department" type="text"
                                                ...
                                                value="{{ !empty($user_detail->department) ? $user_detail->department : '' }}"
