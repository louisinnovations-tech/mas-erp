...
@section('page-title', __('Deal Stage'))

@section('action-button')
    @if(\Auth::user()->can('manage crm'))
        <div class="text-sm-end d-flex all-button-box justify-content-sm-end">
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="Add Deal Stage" data-url="{{ route('dealStage.create') }}" data-toggle="tooltip"
                title="{{ __('Create New Deal Stage') }}" data-bs-original-title="{{__('Create New Deal Stage')}}" data-bs-placement="top" data-bs-toggle="tooltip">
                                        ...
                                        <span class="float-end">
                                            ...
                                            <div class="action-btn bg-light-secondary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center "
                                                    data-url="{{ route('dealStage.edit', $deal_stages->id) }}" data-size="md"
                                                    data-ajax-popup="true" data-title="{{ __('Edit Deal Stage') }}"
                                            ...
                                            <div class="action-btn bg-light-secondary ms-2">
                                                <a href="#"
                                                    ...
                                                    data-confirm-yes="delete-form-{{ $deal_stages->id }}"
                                            ...
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                                'route' => ['dealStage.destroy', $deal_stages->id],
                                                'id' => 'delete-form-' . $deal_stages->id,
                                            ]) !!}
                                            {!! Form::close() !!}
                                        </span>
                                    </li>
