...
@php
    ...
    $settings = Utility::getCompanyPaymentSetting(Auth::user()->creatorId());
@endphp
@section('content')
    <div class="row g-0 p-0">
        @if (!empty(Utility::settings()['chatgpt_key']))
            <div class="row text-end my-2">
                <div class="col-12 ">
                    <div class="text-end">
                        <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
                            data-url="{{ route('generate', ['cases']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        <div class="form-group" id="customer-box">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="bill_from" id="company" value="company"
                                        ...
                                        <div class="form-group d-none" id="advocate_div">
                                            {{ Form::label('advocate', __('Advocate'), ['class' => 'form-label']) }}
                                            {{ Form::select('advocate', $advocates, '', ['class' => 'form-control select2 item', 'id' => 'selected-advocate']) }}
                                        </div>
                                        <div id="advocate_detail" class="d-none form-group"></div>
                                        <input type="hidden" name="company"
                                            value="{{ Utility::getcompanyValByName('id') }}">
                                        <div class="form-group" id="custom_advocate_div">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <span>
                                                        {{ Utility::getcompanydetailValByName('ofc_address_line_1') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('client', $clients, '', ['class' => 'form-control multi-select item', 'id' => 'clients']) }}
                                        </div>
                                        ...
                                        <div class="row flex-column items-end align-items-end">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-icon-user">
                                                        <input type="text" class="form-control"
                                                            value="{{ $invoice_number }}" readonly name="bill_number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row ps-0">
                                                <div class="col-md-6 ps-1">
                                                    <div class="form-group">
                                                        {{ Form::label('reciept_date', __('Date'), ['class' => 'form-label']) }}
                                                        <div class="form-icon-user">
                                                            {{ Form::date('reciept_date', date('Y-m-d'), ['class' => 'form-control']) }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ps-1">
                                ...
                                <div class="col-12">
                                    <div class="card repeater shadow-none border">
                                        <div class="item-section py-2">
                                            <div class="row ">
                                                <div class="col-md-12 d-flex items-end justify-content-end">
                                                ...
                                                <table class="table  mb-0 table-custom-style" data-repeater-list="items"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ __('Numbers') }}</th>
                                                            <th>{{ __('Rate/Unit Cost ') . '(' . $settings['site_currency'] . ')' }}
                                                            </th>
                                                            <th>{{ __('Discount') . '(' . $settings['site_currency'] . ')' }}
                                                            </th>
                                                            <th>{{ __('Tax') }} (%)</th>
                                                            <th class="text-end">
                                                                {{ __('Amount') }} <br>
                                                                <small
                                                                    class="text-danger font-weight-bold">{{ __('tax included') }}</small>
                                                            </th>
                                                            <th></th>
                                                            <th></th>
                                                        </tr>
                                                    ...
                                                    <tbody class="ui-sortable" data-repeater-item>
                                                        <tr>
                                                            <td width="25%" class="form-group pt-0">
                                                                ...
                                                                {{ Form::text('particulars', null, ['class' => 'form-control particulars', 'required' => 'required']) }}

                                                            </td>
                                                            <td>
                                                                <div
                                                                    class="form-group price-input input-group search-form">
                                                                    {{ Form::number('numbers', '', ['class' => 'form-control numbers', 'required' => 'required', 'required' => 'required']) }}
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <div class="form-group">
                                                                    {{ Form::textarea('description', null, ['class' => 'form-control', 'rows' => '2', 'placeholder' => __('Description'), 'required' => 'required']) }}
                                                                </div>
                                                            </td>
                                                            <td colspan="5"></td>
                                                        </tr>
        ...
        $(document).on('keyup', '.numbers', function() {
            ...
            if (!el.find('.particulars').val()) {
                ...
                if (el.find('.particulars').parent().find('small').length == 0) {
                    el.find('.particulars').parent().append(
                        '<small class="text-danger">{{ __('Please Enter Value') }}</small>');
                }
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        for (var j = 0; j < priceInput.length; j++) {
                            totol_amount += (parseFloat(priceInput[j].value) * parseFloat(inputs_quantity[j]
                                .value));
