...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Training Type')}}</h5>
    </div>
@endsection
@section('breadcrumb')
...
<div class="text-sm-end d-flex all-button-box justify-content-sm-end">
    ...
    data-bs-target="#exampleModal" data-url="{{ route('training-type.create') }}"
    data-bs-whatever="{{__('Create New Training Type')}}"> <span class="text-white"> 
                                        ...
                                        <td class="text-end">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal" data-url="{{ route('training-type.edit',$trainingtype->id) }}"
                                                    data-bs-whatever="{{__('Edit Training Type')}}" > <span class="text-white"> <i
