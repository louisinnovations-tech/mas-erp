...
class CasesHistory extends Model
{
    ...
    public static function getCasesHistoryById($id){

        $cases = CasesHistory::whereIn('id',explode(',',$id))->pluck('title')->toArray();
        return implode(',',$cases);
    }

    public static function caseHistoryType(){
        $types = [
    ...
    public static function caseHistoryPriority(){
        return [
    ...
    public static function caseHistoryJourney(){
        return [
            'Client Intake Phase',
