...
<header
    class="dash-header {{ isset($settings['cust_theme_bg']) && $settings['cust_theme_bg'] == 'on' ? 'transprent-bg' : '' }}">
    <div class="header-wrapper">
        <div class="me-auto dash-mob-drp">
            <ul class="list-unstyled">
                        ...
                        <span class="theme-avtar">
                            @if (Request::segment(1) == 'chats')
                                <img alt="#" style="width:30px;"
                                    src="{{ !empty(\Auth::user()->avatar) ? $logo . basename(\Auth::user()->avatar) : $logo . '/avatar.png' }}"
                                    class="header-avtar">
                            @else
                                <img alt="#" style="width:30px;"
                ...
                {{-- <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link  me-0 " href="{{ route('user.ticket.create') }}" target="__blank"
                        role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="theme-avtar">
