        ...
        foreach ($attendance as $key => $value) {
            if ($key != 0) {
                ...
                if (!empty($employeeData)) {
                    ...
                    $totalLateSeconds = strtotime($startTime) - strtotime($clockIn);
                    ...
                    if ($check) {
                        $check->update([
                            'late' => ($late > 0) ? $late : '00:00:00',
                            'early_leaving' => ($earlyLeaving > 0) ? $earlyLeaving : '00:00:00',
                            'overtime' => ($overtime > 0) ? $overtime : '00:00:00',
                            'clock_in' => $value[2],
                            'clock_out' => $value[3]
                        ]);
                    } else {
                ...
                if (!empty($request->employee_id)) {
                    ...
                    foreach ($employees as $employee) {
                        ...
                        if ($request->$present == 'on') {
                            ...
                            $employeeAttendance->late          = ($late > 0) ? $late : '00:00:00';
                            $employeeAttendance->early_leaving = ($earlyLeaving > 0) ? $earlyLeaving : '00:00:00';
                            $employeeAttendance->overtime      = ($overtime > 0) ? $overtime : '00:00:00';
                            $employeeAttendance->total_rest    = '00:00:00';
