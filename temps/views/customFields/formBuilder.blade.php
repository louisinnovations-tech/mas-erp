    ...
    @foreach($customFields as $customField)
        ...
        <div class="col-lg-12">
            <div class="form-group mb-3 {{ $customField->width }}">
                ...
                <textarea name="description" class="form-control summernote {{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __($customField->placeholder) }}">{{old('description')}}</textarea>
        ...
        <div class="col-lg-6">
            <div class="form-group mb-3 {{ $customField->width }}">
                <label class="form-label">{{ ($customField->name) }} <small>({{($customField->placeholder)}})</small></label>
