    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                    ...
                    @can('manage user')
                        ...
                        <li class="dash-item dash-hasmenu {{ request()->is('employee*') ? 'active' : '' }}">
                            <a href="{{ route('employee.index') }}" class="dash-link"><span class="dash-micon">
                                    ...
                                    class="dash-mtext">{{ __('Employee') }}</span>
                            </a>
                        </li>
                    @endcan
                @else --}}
                ...
                @endif
                <!-- @can('manage hrm')
                    <li class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['hrm']) ? ' active' : '' }}">
                        <a href="#" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-file-plus"></i></span>
                            <span class="dash-mtext">{{ __('HRM') }}</span>
                        </a>
                    </li>
                @endcan -->
                ...
                @can('manage cause')
                    @if (Auth::user()->type == 'advocate')
                        <li class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['cause']) ? ' active' : '' }}">
                            ...
                            <ul class="dash-submenu">
                                <li class="dash-item dash-hasmenu {{ request()->is('*cause*') ? ' active' : '' }}">
                                    <a class="dash-link" href="{{ route('cause.store') }}">{{ __('Add Causes') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                ...
                @if (Auth::user()->can('manage timesheet') && Auth::user()->type !== 'client')
                    <li
                ...
                @if (Auth::user()->can('manage feereceived') && Auth::user()->type !== 'client')
                    <li
                ...
                @if ( Auth::user()->can('manage crm')  &&
                        ( Auth::user()->type != 'advocate' || Auth::user()->type != 'employee'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link">
                ...
                @endif
                {{-- @if (Auth::user()->can('manage crm') && Auth::user()->type != 'company')
                ...
                @endif --}}
                {{--@if (Auth::user()->type == 'company' || Auth::user()->type == 'advocate' || Auth::user()->can('manage crm'))--}}
                @if (Auth::user()->type == 'company' || Auth::user()->can('manage crm'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link ">
