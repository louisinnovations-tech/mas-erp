...
class Utility extends Model
{
    ...
    private static function fetchSettings($user_id = null){
        ...
        $settings = [
            ...
            'cookie_description' => 'Dear Client, our ERP System uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it to ensure the security and privacy. Please refer to our Privacy Policy for more details.',
