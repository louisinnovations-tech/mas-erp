                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 present_check_in {{ empty($attendance) ? 'd-none' : '' }} ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-auto">
                                                        <input type="time" class="form-control" name="in-{{$employee->user_id}}" value="{{!empty($attendance) && $attendance->clock_in!='00:00:00' ? $attendance->clock_in : App\Models\Utility::getValByName('company_start_time')}}">
                                                    </div>

                                                    <label for="inputValue" class="col-auto control-label">{{__('Out')}}</label>
                                                        <div class="col-auto">
                                                            <input type="time" class="form-control" name="out-{{$employee->user_id}}" value="{{!empty($attendance) &&  $attendance->clock_out !='00:00:00'? $attendance->clock_out : App\Models\Utility::getValByName('company_end_time')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
