            ...
            <div class="p-3">
                <div>
                    <div class="card shadow-none bg-transparent border rounded-0 mb-3">
                        <div class="card-body">
                            {{ Form::model($bill, ['route' => ['bills.update', $bill->id], 'class' => 'w-100', 'method' => 'put']) }}
                            <div class="col-12">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group" id="customer-box">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="bill_from" id="company" value="company"
                                                    ...
                                                    {{ $bill['bill_from'] == 'company' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="bill_from" id="advocate" value="advocate"
                                                    class="form-check-input"
                                                    {{ $bill['bill_from'] == 'advocate' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('client', $clients, $bill->bill_to, ['class' => 'form-control select2 item', 'id' => 'clients']) }}
                                        ...
                                        <div class="row flex-column items-end align-items-end">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-icon-user">
                                                        {{ Form::text('bill_number', null, ['class' => 'form-control', 'readonly']) }}
                                            ...
                                            <div class="col-md-12 row ps-0">
                                                <div class="col-md-6 ps-1">
                                                    <div class="form-group">
                                                        {{ Form::label('reciept_date', __('Date of Receipt'), ['class' => 'form-label']) }}
                                                        <div class="form-icon-user">
                                                    ...
                                                    <tbody class="ui-sortable" data-repeater-item>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div
                                                                    class="form-group price-input input-group search-form">
                                                                    {{ Form::select('tax', $taxes, '', ['class' => 'form-control ptax', 'required' => 'required']) }}
