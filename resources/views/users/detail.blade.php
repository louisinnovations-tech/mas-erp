                ...
                <div class="col-xl-3 border-end border-bottom">
                    <div class="card shadow-none bg-transparent sticky-top" style="top:70px">
                        <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                            ...
                            <a href="#useradd-2" class="list-group-item list-group-item-action">{{ __('Usage Statistics') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#useradd-3" class="list-group-item list-group-item-action">{{ __('Employees') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        </div>
                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <dl class="row col-md-12 p-0">
                                                    <dt class="col-sm-3"><span
                                                            class="h6 text-md mb-0">{{ __('Name:') }}</span></dt>
                                                    <dd class="col-sm-9"><span class="text-md">{{ $user->name }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('Email:') }}</span></dt>
                                                    <dd class="col-md-9"><span class="text-md">{{ $user->email }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('Mobile No:') }}</span></dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->mobile_number) ? $user_detail->mobile_number : '-' }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('Address:') }}</span></dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->address) ? $user_detail->address : '-' }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('City:') }}</span></dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->city) ? $user_detail->city : '-' }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('State:') }}</span></dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->state) ? $user_detail->state : '-' }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('Zip/Postal Code:') }}</span>
                                                    </dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->zip_code) ? $user_detail->zip_code : '-' }}</span>
                                                    </dd>
                                                    <dt class="col-md-3"><span
                                                            class="h6 text-md mb-0">{{ __('Landmark') }}</span></dt>
                                                    <dd class="col-md-9"><span
                                                            class="text-md">{{ !empty($user_detail->landmark) ? $user_detail->landmark : '-' }}</span>
                                                    </dd>
                                                </dl>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col border-end border-bottom">
                                                        <div class="">
                                                            <div class="d-flex justify-content-between mb-3">
                                                                ...
                                                                <div>
                                                                    <p class="text-muted text-sm mb-0">{{ __('Total') }}
                                                                    </p>
                                                                    <h6 class="mb-0">{{ __('Number of Employees ') }}
                                                                    </h6>
                                                                </div>
                                                            </div>
