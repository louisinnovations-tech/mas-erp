        ...
        <tr data-action="0">
            ...
            <td>
                <div class="avatar av-m" style="background-color: #D9EFFF; text-align: center;">
                    <span class="ti ti-bookmark" style="font-size: 22px; color: #f5d7d7;"></span>
                </div>
            </td>
            {{-- center side --}}
            <td>
    ...
    <table class="messenger-list-item" data-contact="{{ $user->id }}">
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                @php
                    $image = \App\Models\Utility::get_file('uploads/profile');
                @endphp
                @if (!empty($user->avatar))
                    <div class="avatar av-m" style="background-image: url('{{ $image . '/' . $user->avatar }}');">
                    </div>
                @else
