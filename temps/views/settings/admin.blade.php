        ...
        <div class="row g-0">
            <div class="col-xl-3 border-end border-bottom">
                <div class="card shadow-none bg-transparent sticky-top" style="top:70px">
                    <div class="list-group list-group-flush rounded-0" id="useradd-sidenav">
                        ...
                        <a href="#useradd-3" class="list-group-item list-group-item-action">{{ __('Email Settings') }}
                            <div class="float-end dark"><i class="ti ti-chevron-right"></i></div>
                        </a>
                        ...
                        @if (\Auth::user()->type == 'company')
                            <a href="#useradd-10" class="list-group-item list-group-item-action ">{{ __('Google Calendar Settings') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        @endif
                        <a href="#location-list" class="list-group-item list-group-item-action " id="contry-city-state">{{ __('Country/ State/ City Settings') }}
            ...
            <div class="col-xl-9" data-bs-spy="scroll" data-bs-target="#useradd-sidenav" data-bs-offset="0" tabindex="0">
                ...
                <div class="card shadow-none rounded-0 border-bottom" id="useradd-1">
                    {{ Form::model($settings, ['route' => 'business.setting', 'method' => 'POST', 'enctype' =>
                    'multipart/form-data']) }}
                ...
                <!--Payment Setting-->
                <div id="useradd-2" class="card shadow-none rounded-0 border">
                    <div class="card-header">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            <input type="radio"
                                                                                name="iyzipay_mode"
                                                                                value="local"
                                                                                class="form-check-input" {{ !isset($company_payment_setting['iyzipay_mode']) || $company_payment_setting['iyzipay_mode']=='' || $company_payment_setting['iyzipay_mode']=='local' ? 'checked="checked"' : '' }}>
                                                                            {{__('Local')}}
                                                                        </label>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_host', env('MAIL_HOST'), ['class' => 'form-control ','id'=>'mail_host',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_port', env('MAIL_PORT'), ['class' => 'form-control','id'=>'mail_port',
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_username', env('MAIL_USERNAME'), ['class' => 'form-control','id'=>'mail_username',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_password', env('MAIL_PASSWORD'), ['class' => 'form-control','id'=>'mail_password',
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_encryption', env('MAIL_ENCRYPTION'), ['class' => 'form-control','id'=>'mail_encryption',
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    'form-label']) }}
                                    {{ Form::text('mail_from_address', env('MAIL_FROM_ADDRESS'), ['class' =>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('mail_from_name', env('MAIL_FROM_NAME'), ['class' => 'form-control','id'=>'mail_from_name',
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                {{ Form::text('chatgpt_model', isset($settings['chatgpt_model']) ? $settings['chatgpt_model'] : '', ['class' => 'form-control', 'placeholder' => __('Enter Chatgpt Model')]) }}
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-end">
