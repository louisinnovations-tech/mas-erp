...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::password('password', ['class' => 'form-control', 'placeholder' => __('Enter User Password'), 'required' => 'required', 'minlength' => '8', 'autocomplete' => 'new-password']) }}
                        ...
                        <tbody>
                            ...
                            @foreach ($modules as $module)
                                <tr>
                                    <td width="10%">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input ischeck" name="checkall"
